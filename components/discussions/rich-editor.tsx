...
export function RichEditor({ onChange, placeholder = 'Nội dung bài viết...', className }: RichEditorProps) {
  ...
  return (
    <div className={cn('rounded-xl border border-[#e5e7eb] bg-white', className)}>
      {/* Toolbar */}
      <div className="flex items-center gap-0.5 border-b border-[#e5e7eb] px-4 py-2.5">
      ...
      {/* Editor area */}
      <EditorContent editor={editor} className="min-h-[260px] px-5 py-4 text-[15px] text-gray-800" />
    </div>
  )
}
